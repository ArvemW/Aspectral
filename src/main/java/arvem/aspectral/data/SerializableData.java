...
import arvem.aspectral.AspectData;
...
public class SerializableData {
    ...
    public void write(ByteBuf buffer, Instance instance) {
    ...
    public <T> JsonObject write(Instance instance) {
        ...
        dataFields.forEach((name, field) -> instance.ifPresent(name, o -> {
            try {
                ...
                AspectData.LOGGER.atSevere().log("There was a problem serializing field {} with data type {} to JSON (skipping): {}", name, o.getClass(), e.getMessage());
            }
        }));
