...
/**
 * An ability that provides a numeric resource value that can be modified.
...
public class ResourceAbility extends Ability {
    ...
    public ResourceAbility(AbilityType<?> type, LivingEntity entity,
    ...
    public static AbilityFactory<ResourceAbility> createFactory() {
        return new AbilityFactory<ResourceAbility>(
            ...
            data -> (type, entity) -> new ResourceAbility(
                type, entity,
                data.get("min"),
                data.get("max"),
